...
const scripts=['/setup-course-v3.js','/project-course-v4.js','/smart-mirror-course-v6.js','/smart-mirror-v6-qa.js'];
for(const src of scripts){const tag=`<script src="${src}"></script>`;if(!html.includes(tag))html=html.replace('</body>',`${tag}\n</body>`)}
fs.writeFileSync(indexPath,html,'utf8');
console.log('Built dist with Setup V3, generic Project Course V4, isolated Smart Mirror Course V6, and V6 QA enforcement.');