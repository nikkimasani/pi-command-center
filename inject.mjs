...
const scripts=['/setup-course-v3.js','/project-course-v4.js','/smart-mirror-course-v6.js','/smart-mirror-v6-qa.js','/smart-mirror-visual-manifest.js','/smart-mirror-setup-coach.js'];
for(const src of scripts){const tag=`<script src="${src}"></script>`;if(!html.includes(tag))html=html.replace('</body>',`${tag}\n</body>`)}
fs.writeFileSync(indexPath,html,'utf8');
console.log('Built dist with Setup V3, generic Project Course V4, isolated Smart Mirror Course V6, V6 QA enforcement, fixed Smart Mirror visual manifest, and interactive setup coach.');