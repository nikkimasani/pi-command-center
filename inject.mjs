...
const scripts=['/setup-course-v2.js','/project-course-v3.js','/course-quality-v5.js','/visual-registry-v6.js','/command-copy-v6.js','/hardware-accuracy-v7.js'];
for(const src of scripts){const tag=`<script src="${src}"></script>`;if(!html.includes(tag))html=html.replace('</body>',`${tag}\n</body>`)}
fs.writeFileSync(indexPath,html,'utf8');
console.log('Built dist with detailed Pi setup, exact visuals, per-command copy controls, and Pi 5 hardware accuracy guidance.');